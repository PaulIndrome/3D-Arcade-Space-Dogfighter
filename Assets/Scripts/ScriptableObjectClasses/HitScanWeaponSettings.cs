...
namespace Soulspace {
    ...
    public class HitScanWeaponSettings : WeaponSettingsBase
    {
        ...
        [SerializeField, Tooltip("For hitscan weapons, max range does not depend on velocity and despawn time but is statically set here.")] private float maxWeaponTargetingRange = 100f;
    ...
    #region accessors
        ...
        public override float MaxWeaponTargetingRange => maxWeaponTargetingRange;
