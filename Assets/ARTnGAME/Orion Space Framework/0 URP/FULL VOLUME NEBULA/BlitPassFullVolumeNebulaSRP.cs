...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal class BlitPassFullVolumeNebulaSRP : UnityEngine.Rendering.Universal.ScriptableRenderPass
    {
       ...
       // public bool _fastest = false;
        ...
        /// </summary>
        public BlitPassFullVolumeNebulaSRP(UnityEngine.Rendering.Universal.RenderPassEvent renderPassEvent, Material blitMaterial, int blitShaderPassIndex, string tag, BlitFullVolumeNebulaSRP.BlitSettings settings)
        {
     ...
     //           isForReflections = connector.isForReflections;
        ...
        {           
            ...
            Blit(cmd, m_TemporaryColorTexture.Identifier(), source, sheetSHAFTS, (screenBlendMode == BlitFullVolumeNebulaSRP.BlitSettings.ShaftsScreenBlendMode.Screen) ? 0 : 4);
       ...
       // public int resolution = 256;
        ...
        //public override void Render(PostProcessRenderContext context)
        {
            ...
            if (sunShaftIntensity != 0)
            {
                ...
                RenderShaftsNEBULA(context, renderingData, ref cmd, opaqueDesc);
            }
            else
            {
                Blit(cmd, tmpBuffer1, source, CloudMaterial, 11);
        ...
        //SHAFTS_NEBULA
        public void RenderShaftsNEBULA(ScriptableRenderContext context, UnityEngine.Rendering.Universal.RenderingData renderingData, ref CommandBuffer cmd, RenderTextureDescriptor opaqueDesc)
        {
            opaqueDesc.depthBufferBits = 0;
            Material sheetSHAFTS = blitMaterial;
